...
export const PostItem = ({ post, controllerFlag, confirmDeletion }) => {
  ...
  return (
    <>
      <li className={classes["filmCard"]} key={elId}>
        <div
          className={classes["image__container"]}
          style={{ backgroundImage: `url(${image})` }}
        ></div>
        <div className={classes["filmCard__information"]}>
          <div className={classes["filmCard__header"]}>
            <div>
          ...
          <div className={classes["filmCard__description"]}>{description}</div>
          <div className={classes["filmCard__prefixText"]}>
            Вам понадобится:
          </div>
          <div className={classes["filmCard__ingredients"]}>{ingredients}</div>
          <div className={classes["filmCard__footer"]}>
            <div className={classes["filmCard__likes"]}>
              <button
                type="button"
            ...
            <div className={classes["filmcard__difficulty"]}>{difficulty}</div>
          </div>
        </div>
      </li>
